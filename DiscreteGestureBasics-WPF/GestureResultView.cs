...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        private readonly ImageSource paperImage = new BitmapImage(new Uri(@"Images\seatPaper.png", UriKind.Relative));
        private readonly ImageSource waveImage = new BitmapImage(new Uri(@"Images\waveHand.png", UriKind.Relative));
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence, string gestureName)
        {
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    if (gestureName.Equals("paper"))
                    {
                        this.ImageSource = this.paperImage;
                    }
                    else if (gestureName.Equals("wave"))
                    {
                        this.ImageSource = this.waveImage;
                    }
                    else
                    {
                        this.ImageSource = this.notSeatedImage;
