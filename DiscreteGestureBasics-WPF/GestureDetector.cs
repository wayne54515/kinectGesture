...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        //private readonly string gestureDatabasePaper = @"Database\*.gba";
        //private readonly string gestureDatabaseWave = @"Database\*.gba";
        ...
        private readonly string paperGestureName = "seatPaper";
        private readonly string waveGestureName = "waveHand";
...
*/
            ...
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.gestureDatabase))
            {
                ...
                Console.WriteLine(database.AvailableGesturesCount);
                    ...
                    if (discreteResults != null)
                    {
                        ...
                        foreach (Gesture gesture in this.vgbFrameSource.Gestures)
                        {
                            ...
                            if (gesture.Name.Equals(this.seatedGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
                                ...
                                if ((result != null) && (result.Confidence > 0.15f))
                                {
                                    Console.WriteLine(gesture.Name);
                                    // update the GestureResultView object with new gesture result values
                                    this.GestureResultView.UpdateGestureResult(true, result.Detected, result.Confidence, "seat");
                                }
                            }
                            ...
                            if (gesture.Name.Equals(this.paperGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
                                ...
                                if ((result != null) && (result.Confidence > 0.0f))
                                {
                                    Console.WriteLine(gesture.Name);
                                    // update the GestureResultView object with new gesture result values
                                    this.GestureResultView.UpdateGestureResult(true, result.Detected, result.Confidence, "paper");
                                }
                            }
                            ...
                            if (gesture.Name.Equals(this.waveGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
                                ...
                                if ((result != null) && (result.Confidence > 0.5f))
                                {
                                    Console.WriteLine(gesture.Name);
                                    // update the GestureResultView object with new gesture result values
                                    this.GestureResultView.UpdateGestureResult(true, result.Detected, result.Confidence, "wave");
                                }
                            }
                        }
                    }
